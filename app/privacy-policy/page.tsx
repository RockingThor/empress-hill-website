  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 md:py-16">
        <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 font-poppins">
          Privacy Policy — Empress Hill
        </h1>
        ...
        <div className="prose prose-lg max-w-none text-gray-700 font-poppins space-y-6">
          <p>
            ...
            , submit your details through online forms or advertisements, or
            interact with us through digital platforms including Meta (Facebook
            & Instagram).
          </p>
          <p>
            By accessing or using our website or submitting your information,
          ...
          <section className="mt-8">
            ...
            <ul className="list-disc list-inside space-y-1 ml-4">
              ...
              <li>
                Digital advertising platforms (e.g., Meta, Google) for
                retargeting
              </li>
          ...
          <section className="mt-8">
            ...
            <p>
              Our website may use cookies or tracking technologies to enhance
              your browsing experience. You can modify your browser settings to
              decline cookies, but certain features may not function properly.
            </p>
          </section>
          ...
          <section className="mt-8">
            ...
            <p>
              Our website or ads may contain links to third-party pages. We are
        ...
        <div className="mt-12 text-center">
          <Link
            href="/"
            className="text-[#8E6C70] hover:underline font-poppins"
          >
            ← Back to Home
          </Link>
        </div>
