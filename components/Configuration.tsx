    ...
    return (
        ...
        /> */}
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    <h1 className="text-5xl text-[#725054] font-gentium-plus mb-10 mt-10">Configuration</h1>
                ...
                <div className="flex flex-col items-center justify-center gap-5 mt-15">
                    <button onClick={openModal} className="bg-[#FFFFFF] text-[#BD314C] px-5 py-3 rounded-md font-bold cursor-pointer shadow-lg hover:bg-gray-100 transition-colors duration-200">
                        E-BROCHURE
                    </button>
                </div>
            </div>
        ...
        /> */}
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    <h1 className="text-4xl text-[#725054] font-gentium-plus mb-10 mt-10">Configuration</h1>
                ...
                <div className="flex flex-col items-center justify-center gap-5 mt-10 pb-10">
                    <button onClick={openModal} className="bg-[#FFFFFF] text-[#BD314C] px-5 py-3 rounded-md font-bold cursor-pointer shadow-lg hover:bg-gray-100 transition-colors duration-200 z-50">
                        E-BROCHURE
                    </button>
                </div>
            </div>
