    ...
    return (
        ...
        /> */}
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    <h1 className="text-5xl  text-[#725054] font-gentium-plus mb-10 mt-10">Overview</h1>
                    <p className="text-lg text-[#725054] font-poppins max-w-[70vw] text-center mb-10">
                        Tucked away in the peaceful landscapes of Goa, Empress Hill offers an exclusive collection of 3 BHK apartments and duplexes designed for those who value grace, privacy, and
                        timeless elegance.
                    </p>
                    <p className="text-lg text-[#725054] font-poppins max-w-[70vw] text-center">
                        With just 24 residences spread across 9 floors, this boutique address brings you the comfort of thoughtful living and the charm of serene luxury, a place where life flows
                        beautifully, like royalty.
                    </p>
                </div>
            </div>
        ...
        /> */}
                ...
                <div className="flex flex-col items-center justify-center h-full">
                    <h1 className="text-4xl  text-[#725054] font-gentium-plus mb-10 mt-10">Overview</h1>
                    <p className=" text-[#725054] font-poppins max-w-[70vw] text-center mb-10">
                        Tucked away in the peaceful landscapes of Goa, Empress Hill offers an exclusive collection of 3 BHK apartments and duplexes designed for those who value grace, privacy, and
                        timeless elegance.
                    </p>
                    <p className=" text-[#725054] font-poppins max-w-[70vw] text-center">
                        With just 24 residences spread across 9 floors, this boutique address brings you the comfort of thoughtful living and the charm of serene luxury, a place where life flows
                        beautifully, like royalty.
                    </p>
                </div>
