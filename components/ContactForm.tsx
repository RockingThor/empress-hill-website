            ...
            in touch with us!
                ...
                {submissionState.success && (
                    <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded mb-4">
                        <p className="text-sm">Thank you for your inquiry! Someone from our team will contact you shortly.</p>
                    </div>
                )}
                        ...
                        <div className="relative group space-y-1" key={field.name}>
                            <div
                                className={`flex shadow-xl transition-all duration-300 rounded-lg overflow-hidden ${
                                    focusedField === field.name ? 'shadow-xl scale-[1.02]' : 'hover:shadow-xl hover:scale-[1.01]'
                                }`}
                            >
                                {/* Icon Section */}
                            ...
                            {/* Error Message */}
                            {validationErrors[field.name as keyof ValidationErrors] && <p className="text-red-500 text-xs ml-16">{validationErrors[field.name as keyof ValidationErrors]}</p>}
                        </div>
                    ))}
              ...
              `}
                        ...
                        <label htmlFor="consent" className="text-gray-300 leading-relaxed font-sans text-center text-xs">
                            ...
                            <Link href="/privacy-policy" className="text-[#d9acb1] hover:underline underline" target="_blank">
                                Privacy Policy
                            </Link>
                            .
                        </label>
                        ...
                        >
                            {submissionState.isLoading ? (
                                <>
                                    ...
                                    <span className="font-semibold text-md tracking-wider">SUBMITTING...</span>
                                </>
                            ) : submissionState.success ? (
                                <>
                                    ...
                                    <span className="font-semibold text-md tracking-wider">SUCCESS!</span>
                                </>
                            ) : (
                                <>
                                    <span className="bg-opacity-20 rounded-full p-2 group-hover:bg-opacity-30 transition-all duration-300">
                                    ...
                                    <span className="font-semibold text-md tracking-wider">SUBMIT</span>
                                </>
                            )}
                        </button>
                    </div>
