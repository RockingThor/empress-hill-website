...
const sampleImages = ['/4bhk/1.jpg', '/4bhk/2.jpg', '/4bhk/3.jpg', '/4bhk/4.jpg', '/4bhk/5.jpg'];

const sampleImages_mobile = ['/4bhk_mobile/1.png', '/4bhk_mobile/2.png', '/4bhk_mobile/3.png', '/4bhk_mobile/4.png'];
    ...
    return (
        <div id="four-bhk-duplexes">
            <div className="bg-gradient-to-b from-[#F8F0ED] to-[#FBEFEB] w-full h-full pb-10 hidden  md:flex flex-col gap-5  ">
                <div className="w-full h-[100vh]">
                    <ImageSlider images={sampleImages} autoPlayInterval={5000} showArrows={true} showDots={true} />
                </div>
                <div className="flex flex-col text-center gap-5 w-[30vw] p-5 items-center  mx-auto">
                    ...
                    <div className="flex flex-col items-center justify-center text-center gap-5">
                        <div className="flex flex-row items-center justify-center text-center gap-5">
                            <h1 className="text-5xl  text-[#725054] font-gentium-plus">4 BHK</h1>
                            <h1 className="text-5xl  text-[#725054] font-gentium-plus italic">Duplexes</h1>
                        </div>
                        <p className="text-lg text-[#725054] font-poppins">Our 4 BHK duplexes redefine luxury with expansive layouts spread across two levels.</p>
                        <p className="text-lg text-[#725054] font-poppins">These homes bring villa-like privacy with the convenience of apartment living; perfect for those who desire more.</p>
                    </div>
                </div>
            </div>
        ...
        /> */}
                <div className="flex flex-row items-center justify-center gap-5 w-full">
                    <Image src="/4bhk/unit_1.png" alt="4BHK floor plan" width={600} height={600} />
                    <Image src="/4bhk/unit_2.png" alt="4BHK floor plan" width={600} height={600} />
                </div>
            ...
            <div className="bg-gradient-to-b from-[#F8F0ED] to-[#FBEFEB] w-full h-full pb-10 md:hidden flex-row gap-5  ">
                <div className="flex flex-col items-center justify-center text-center gap-5">
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <h1 className="text-4xl  text-[#725054] font-gentium-plus">4 BHK</h1>
                        <h1 className="text-4xl  text-[#725054] font-gentium-plus italic">Duplexes</h1>
                    </div>
                </div>

                <div className="w-full h-80 mt-5">
                    <ImageSlider images={sampleImages_mobile} autoPlayInterval={5000} showArrows={true} showDots={true} />
                </div>
                <div className="flex flex-col bg-[#725054] w-full h-full items-center justify-center p-5 gap-5 py-12">
                    <h2 className="text-2xl text-[#EFE7E5] font-poppins text-[16px] font-semibold">OVERVIEW</h2>
                    <p className=" text-[#EFE7E5] text-[12px] font-poppins text-center mt-[-2vh]">
                        Our 4 BHK duplexes redefine luxury with expansive layouts spread across two levels. These homes bring villa-like privacy with the convenience of apartment living; perfect for
                ...
                <div className="bg-gradient-to-b from-[#F8F0ED] to-[#FBEFEB] w-full h-full flex flex-col items-center mt-10 mb-2">
                    ...
                    <h1 className="text-4xl  text-[#725054] font-gentium-plus flex flex-row items-center justify-center gap-0.5 ">
                        Unit
                        <span className="text-4xl  text-[#725054] font-gentium-plus italic ml-2">Plan</span>
                    </h1>
                    <div className="w-full h-50 mt-5 ">
                        <ImageSlider images={unitPlan_mobile} autoPlayInterval={5000} showArrows={true} showDots={true} paddingNeeded={true} />
                    </div>
                </div>
            </div>
        </div>
