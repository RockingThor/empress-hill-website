    ...
    return (
        <div className="space-y-8 p-8">
            ...
            <div className="space-y-4">
                <h3 className="text-xl font-semibold">Basic Image Slider (Auto-rotates every 5 seconds)</h3>
            ...
            {/* Custom Interval */}
            <div className="space-y-4">
                <h3 className="text-xl font-semibold">Fast Auto-rotation (2 seconds)</h3>
                <div className="w-full h-96">
                    <ImageSlider images={sampleImages} autoPlayInterval={2000} showArrows={true} showDots={true} />
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="w-full h-96">
                    <ImageSlider images={sampleImages} autoPlayInterval={5000} showArrows={true} showDots={false} />
                </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="w-full h-96">
                    <ImageSlider images={sampleImages} autoPlayInterval={5000} showArrows={false} showDots={true} />
                </div>
            </div>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <ul className="list-disc list-inside space-y-1 ml-4">
                        ...
                        <li>
                            <code>autoPlayInterval</code>: Time in milliseconds between auto-advances (default: 5000)
                        </li>
                        <li>
                            <code>showArrows</code>: Show/hide navigation arrows (default: true)
                        </li>
                        <li>
