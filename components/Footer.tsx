...
const Footer = () => {
    return (
        <div id="contact-us">
            <div className="bg-linear-to-br from-[#735054] via-[#735054] to-[#8e6e71] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 p-4 md:p-10 md:max-h-[70vh]">
